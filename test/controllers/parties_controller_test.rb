...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post parties_url, params: { party: { begin: @party.begin, end: @party.end, hours: @party.hours, name: @party.name } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { begin: @party.begin, end: @party.end, hours: @party.hours, name: @party.name } }
